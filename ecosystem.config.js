  ...
  apps: [
    {
      ...
      env: {
        NODE_ENV: 'production',
        PORT: 3012,
        JWT_SECRET: process.env.JWT_SECRET || 'gozcu-super-secure-secret-key-2024-change-in-production'
      },
      error_file: '/var/log/pm2/gozcu-backend-error.log',
      out_file: '/var/log/pm2/gozcu-backend-out.log',
      log_file: '/var/log/pm2/gozcu-backend.log',
      time: true,
      autorestart: true,
      watch: false,
